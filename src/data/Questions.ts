...
const questions: Question[] = [
  ...
  { type: 'multiple', text: '¿Cuántas veces a la semana realizas ejercicio cardiovascular?', options: ['No realizo', '1 a 2 veces', '3 a 4 veces', '5 a 6 veces', 'Toda la semana'] },
  { type: 'multiple', text: '¿Cuántas veces a la semana realizas ejercicio de fuerza?', options: ['No realizo', '1 a 2 veces', '3 a 4 veces', '5 a 6 veces', 'Toda la semana'] },
  { type: 'multiple', text: '¿Cuántas comidas tienes en un día?', options: ['1 comida', '2 comidas', '3 comidas', '4 comidas', '5 comidas'] },
